...
-   :doc:`interbotix_xsarm_control<ros1_packages/arm_control>` - contains the motor configuration files and the
    'root' launch file that is responsible for launching the robot arm
-   :doc:`interbotix_xsarm_gazebo<ros1_packages/gazebo_simulation_configuration>` - contains the config files
    necessary to launch an arm in Gazebo, including tuned PID gains for the ros_control package
-   :doc:`interbotix_xsarm_ros_control<ros1_packages/ros_control>` - contains configuration files necessary to
    set up ROS controllers between MoveIt and the physical robot arm
-   :doc:`interbotix_xsarm_moveit<ros1_packages/moveit_motion_planning_configuration>` - contains the config
...
.. toctree::
    ...
    ros1_packages/arm_descriptions.rst
    ros1_packages/arm_control.rst
    ros1_packages/gazebo_simulation_configuration.rst
    ros1_packages/ros_control.rst
    ros1_packages/moveit_motion_planning_configuration.rst
    ros1_packages/perception_pipeline_configuration.rst
    ros1_packages/moveit_interface_and_api.rst
    ros1_packages/python_demos.rst
    ros1_packages/matlab_demos.rst
    ros1_packages/joystick_control.rst
    ros1_packages/record_and_playback.rst
    ros1_packages/arm_diagnostic_tool.rst
    ros1_packages/arm_diagnostic_listener.rst
    ros1_packages/pid_gains_test_environment.rst
    ros1_packages/arm_puppeteering.rst
    ros1_packages/dual_arm_control.rst
    ros1_packages/dual_arm_joystick_control.rst
