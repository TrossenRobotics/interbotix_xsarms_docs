...
.. note::
    ...
    <../ros_interface/index>` has already been installed.

For usage and structure information on the Python interface that builds on top of ROS, check out
the :doc:`Python Demos <../ros_packages/python_demos>` page. Further documentation of the Python
...
.. image:: /_images/xsarm_demos_frames.png
    :align: center
    :width: 40%
